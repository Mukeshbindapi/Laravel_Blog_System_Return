      ...
      <div class="row justify-content-between align-items-center">
        ...
        <div class="col-lg-10 col-md-8 text-center text-lg-right text-md-right">
          <div class="header-top-info mb-2 mb-md-0">
            <a href="tel:+918081771567">Call Us : <span>+918081771567</span></a>
            <a href="mailto:mukeshvidra@gmail.com"><i class="fas fa-envelope mr-2"></i><span>mukeshvidra@gmail.com</span></a>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    ...
    <div class="footer-btm pt-4">
      <div class="row">
        <div class="col-lg-6">
          <div class="copyright">
            Copyright &copy; 2020, Designed &amp; Developed by <a href="#"
              >Themefisher</a>
          </div>
        </div>
